...
{
    public float wobblingXStrenght = 3.3f;
    public float wobblingYStrenght = 2.5f;
    ...
    {
        return new Vector2(Mathf.Sin(time * wobblingXStrenght), Mathf.Cos(time * wobblingYStrenght));
    }
}